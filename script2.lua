...
if not getgenv().MTAPIMutex then loadstring(game:HttpGet("https://raw.githubusercontent.com/robloxscriptleaks/Resources_WillsScripts/main/1.lua", true))() end
...
local Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/robloxscriptleaks/Resources_WillsScripts/main/2.lua'))()
local SaveManager = loadstring(game:HttpGet('https://raw.githubusercontent.com/robloxscriptleaks/Resources_WillsScripts/main/3.lua'))()
